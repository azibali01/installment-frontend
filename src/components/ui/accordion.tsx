...
const Root: any = AccordionPrimitive.Root;
const Item: any = AccordionPrimitive.Item;
const Header: any = AccordionPrimitive.Header;
const TriggerComp: any = AccordionPrimitive.Trigger;
const ContentComp: any = AccordionPrimitive.Content;
const ChevronDown: any = ChevronDownIcon;
